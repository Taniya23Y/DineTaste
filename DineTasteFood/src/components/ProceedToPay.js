      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
        {!isPaid ? (
          <>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-xl transition transform hover:scale-105 active:scale-95 mt-4"
              >
                Pay Now
              </button>
            </div>
          ...
          <div className="text-center space-y-4">
            ...
            <button
              className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-xl transition transform hover:scale-105 active:scale-95 mt-4"
              onClick={() => navigate("/")}
            >
              Go to Home
            </button>
